...
This option is slightly preferred by the authors as it keeps the information 
all in one place (state) where it can be easily accessed and validated. The 
only concern is the implementation complexity which may force us to reconsider.
...
TODO(wacban): describe how it combines with resharding?
