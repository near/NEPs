...
NEAR Enhancement Proposals (NEPs) are design document that describe standards for the NEAR platform, including core protocol specifications, contract standards, and wallet APIs. Each NEP provides concise technical specifications and the rational behind the proposed enhancement.
