...
### Verification
An example on how to verify the authentication signature can be [found here](https://github.com/gagdiez/near-login/blob/main/server/authenticate/wallet-authenticate.js).
