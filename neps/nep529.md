...
| **NFT\_STANDARD\_NAME** | Smart Contract Standard | No equivalent | String | NEP529 | 
...
RODiT can also hs the potential to be used for SSH authentication and API authentication.
