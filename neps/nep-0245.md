...
// attributes may be included in this structure but must be marked with null 
// to indicate themselves as optional.
type Token = {
  token_id: string,
...
function mt_transfer(
  receiver_id: string,
  token_id: string,
  amount: string, // this value is ignored if the token is an NFT.
...
function mt_resolve_transfer(
  ...
  token_ids: string[],
  amounts: string[],
  approvals: (null | [owner_id: string, approval_id: number][]) []| null
):string[]  {}
```
