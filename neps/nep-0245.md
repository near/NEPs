...
type Token = {
  ...
  approved_account_ids: Record<string, number> | null // not null if approval extension is enabled
}
...
Here, we simply bring approval management concepts form NEP-178 to the MT to serve those NFTs in MT.
