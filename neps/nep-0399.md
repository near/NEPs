...
With Flat Storage, number of disk reads reduces from 2 * key_length to 2, storage read gas fees are simplified 
by getting rid of TTN cost, and potentially can be reduced because less disk reads are needed.
