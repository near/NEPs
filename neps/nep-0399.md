...
There are other ideas for how to improve storage performance, such as using 
...
Alternatively, we can still get rid of TTN cost by increasing the base fees for storage reads and writes. However, 
  this could require increasing the fees by quite a lot, which could end up breaking many contracts.
- What is the impact of not doing this?
Storage reads will still be inefficiently implemented and cost more than it could be.
