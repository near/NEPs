...
extra disk write for changed key, and 1 auxiliary disk write + removal for each FSD.
We see this as an acceptable tradeoff, because actual disk writes are executed in background and are not a bottleneck
