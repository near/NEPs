...
- ***bls12381_g1_sum —*** adds an array of the signed points from $G_1$ on an elliptic curve. This function is useful for the aggregation of public keys in BLS Signature. Can be used for simple addition in $G_1$. Separate from the multiexp function due to the gas cost.
...
- ***bls12381_map_fp_to_g1 —*** maps base field element into the $G_1$ point. Doesn’t perform mapping of the byte string into field elements. Transfer field element into a curve. It is necessary for signature schemes.
- ***bls12381_map_fp2_to_g2 —*** maps extension field element into the $G_2$ point. Doesn’t perform mapping of the byte string into extension field elements. 
