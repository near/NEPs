...
- bls12381_g1_sum
- bls12381_g2_sum
- bls12381_map_fp2_to_g2 -- we need this function to map message to the element of the group. We don't implement hash_to_field[^60] function, because it can be done inside a contract and different hashing algorithms can be used.
- bls12381_decompress_g1 -- some protocols provide points on the curve in the compressed form (e.g., the light client updates in Ethereum 2.0), and decompressing is a time-consuming operation. All the other functions in this NEP accept only decompressed points to be simple and to have optimized gas consumption.
