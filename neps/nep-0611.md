...
1. Limiting the number of in-flight transactions for accounts without contracts: This aims for backwards compatibility for most use cases and also limits the amount of spam they can include on chain.
