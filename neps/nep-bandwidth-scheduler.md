...
![](assets/nep-bandwidth-scheduler/basic-flow.png)
...
![](assets/nep-bandwidth-scheduler/scheduler_example_1.png)
...
![](assets/nep-bandwidth-scheduler/scheduler_example_2.png)
...
![](assets/nep-bandwidth-scheduler/scheduler_example_3.png)
...
![](assets/nep-bandwidth-scheduler/scheduler_example_4.png)
...
![](assets/nep-bandwidth-scheduler/scheduler_example_5.png)
...
![](assets/nep-bandwidth-scheduler/scheduler_example_6.png)
...
![](assets/nep-bandwidth-scheduler/one-missing-chunk.png)
...
![](assets/nep-bandwidth-scheduler/distribute_remaining_example_1.png)
...
![](assets/nep-bandwidth-scheduler/distribute_remaining_example_2.png)

Link (0 -> 0): Sender proposes 267kB/1 = 267kB. Receiver proposes 700kB/3 = 233kB. Grant 233kB

![](assets/nep-bandwidth-scheduler/distribute_remaining_example_3.png)
...
![](assets/nep-bandwidth-scheduler/distribute_remaining_example_4.png)

Link (2 -> 0): Sender proposes 1467kB/1 = 1467kB. Receiver proposes 467kB/2 = 233kB. Grant 233kB

![](assets/nep-bandwidth-scheduler/distribute_remaining_example_5.png)
...
![](assets/nep-bandwidth-scheduler/distribute_remaining_example_6.png)

Link (1 -> 0): Sender proposes 4467kB/2 = 2233kB. Receiver proposes 233kB/1 = 233kB. Grant 233kB

![](assets/nep-bandwidth-scheduler/distribute_remaining_example_7.png)

Link (1 -> 2): Sender proposes 4234kB/1 = 4234kB. Receiver proposes 4.5MB. Grant 4234kB

![](assets/nep-bandwidth-scheduler/distribute_remaining_example_8.png)
