...
/// The Public key must be in a binary format with base58 string serialization with human-readable curve prefix.
...
/// The private key should be serialized with borsh
