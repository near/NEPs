    ...
    FungibleTokenCore + FungibleTokenReceiver
{
    ...
    fn underlying_asset_contract_id(&self) -> AccountId;
    ...
    fn underlying_asset_amount(&self) -> U128;
...
-   To mitigate the risk of unfavorable execution due to block delays, vault contracts may optionally implement the following methods, which act as "slippage-protected" counterparts to `redeem` and `withdraw`.
